...
practical performance of the system, while preserving it mathematical
correctness.  They will also gain a stronger mastery of static (data
flow) analyses for a practical impure language.
