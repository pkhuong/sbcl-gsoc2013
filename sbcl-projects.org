...
serious compilers thus exploit that fact to simplify divisions into
sequences of simpler multiplication, shift and addition.  SBCL
...
programs.  They would likely develop an understanding of the
performance characteristics of contemporary computers to decide how to
let number theory guide the simplification of divisions by integers.
They would also show the correctness of simple but novel
transformations, and exploit their understanding of the problem domain
to develop tests that are likely to detect wrong transformations.
